    ...
    <>
      ...
      <div className="grid2">
        <form className="card" onSubmit={save}>
          ...
          <div className="row">
            <Field label="Guest name placeholder ({{guest}} until PMS arrives)"><input value={f.guest_placeholder} onChange={(e) => setF({ ...f, guest_placeholder: e.target.value })} placeholder="Guest" /></Field>
